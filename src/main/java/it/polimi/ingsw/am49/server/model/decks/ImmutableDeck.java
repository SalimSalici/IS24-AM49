...
public class ImmutableDeck<T extends Card> {
     ...
     *              processed in the DeckLoader class {@link DeckLoader}.
    ...
    /**
     * Handles the copy of the cards from the immutable deck to a new list that is used in DeckLoader {@link DeckLoader} to
